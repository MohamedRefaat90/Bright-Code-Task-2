...
abstract class bright_codeTheme {
  ...
  static bright_codeTheme of(BuildContext context) {
...
class LightModeTheme extends bright_codeTheme {
  @Deprecated('Use primary instead')
  Color get primaryColor => primary;
  @Deprecated('Use secondary instead')
  Color get secondaryColor => secondary;
...
class DarkModeTheme extends bright_codeTheme {
  @Deprecated('Use primary instead')
  Color get primaryColor => primary;
  @Deprecated('Use secondary instead')
  Color get secondaryColor => secondary;
