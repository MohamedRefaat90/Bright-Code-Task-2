...
Widget wrapWithModel<T extends bright_codeModel>({
  required T model,
...
T createModel<T extends bright_codeModel>(
...
abstract class bright_codeModel<W extends Widget> {
...
class bright_codeDynamicModels<T extends bright_codeModel> {
  bright_codeDynamicModels(this.defaultBuilder);
