...
class _TabBarScrollPosition extends ScrollPositionWithSingleContext {
  ...
  final _bright_codeButtonTabBarState tabBar;
...
/// A bright_code Design widget that displays a horizontal row of tabs.
class bright_codeButtonTabBar extends StatefulWidget
  ...
  /// and the entire [bright_codeButtonTabBar] is scrollable. Otherwise each tab gets an equal
  ...
  @override
  State<bright_codeButtonTabBar> createState() =>
      _bright_codeButtonTabBarState();
}

class _bright_codeButtonTabBarState extends State<bright_codeButtonTabBar>
  ...
  @override
  void didUpdateWidget(bright_codeButtonTabBar oldWidget) {
