...
class bright_codeIconButton extends StatefulWidget {
  const bright_codeIconButton({
    Key? key,
    required this.icon,
    this.borderColor,
    this.borderRadius,
  ...
  @override
  State<bright_codeIconButton> createState() => _bright_codeIconButtonState();
}

class _bright_codeIconButtonState extends State<bright_codeIconButton> {
  bool loading = false;
  ...
  @override
  void didUpdateWidget(bright_codeIconButton oldWidget) {
